  ...
  return (
    <div>
      ...
      <div className="btn-container">
        <button className="btn" onClick={() => window.location.href = "https://www.linkedin.com/in/liam-j-davis/"}>
          Linkedin
        </button>

        <button className="btn" onClick={() => window.location.href = "https://github.com/liamjdavis"}>
          Github
        </button>
      </div>
        ...
        <div class="column left-column">
          <div>
            ...
            <div style={{
              ...
              <img src={AmherstSeal} alt="AmherstSeal" style={{
                width: '100px',
                height: '100px',
                borderRadius: '50%',
                objectFit: 'cover',
            ...
            <div>
              <h3>Amherst College 
                <br></br>
                <p><i>Bachelors of Arts in Mathematics and Computer Science</i>
                  <br></br> 
          ...
          <div>
            ...
            <div>
              <h3>IMC Prosperity Trading Challenge
                <br></br>
                <p><i>Competitor</i>
                  <br></br> 
                  April 2024
          ...
          <div>
            ...
            <div>
              <div>
                <h3 style={{marginBottom:0}}>Programming Languages</h3>
                <ul>
                  <li>Python</li>
                  <li>Java</li>
                  <li>C/C++</li>
              ...
              <div>
                <h3 style={{marginBottom:0}}>Tools</h3>
                <ul>
                  <li>Scikit-learn</li>
                  <li>Pandas + Numpy</li>
                  <li>Pytorch</li>
              ...
              <div>
                <h3 style={{marginBottom:0}}>Technologies</h3>
                <ul>
                  <li>Git + Github</li>
                  <li>Jupyter</li>
                  <li>VSCode</li>
        ...
        <div class="column right-column">
          <div>
            ...
            <div style={{
              ...
              <h3>HP Tech Ventures
                <br></br>
                <p><i>Incoming Business and VC Analytics Extern</i>
                  <br></br> 
                  May 2024 - July 2024
                </p>
              </h3>
            ...
            <div style={{
              ...
              <img src={mammo_bsb} alt="mammo_bsb" style={{
                width: '100px',
                height: '100px',
                borderRadius: '50%',
                objectFit: 'cover',
            ...
            <div style={{
              ...
              <h3>Amherst College Varsity Baseball
                <br></br>
                <p><i>Data and Scouting Analyst</i>
                  <br></br> 
            ...
            <div style={{
              ...
              <h3>Frio Energy Partners
                <br></br>
                <p><i>Software Engineering Intern</i>
                  <br></br> 
                  January 2024 - February 2024

                  <br></br> <br></br>
                  Built data pipeline from financial statements
                  to company database.
                </p>
              </h3>
            </div>
